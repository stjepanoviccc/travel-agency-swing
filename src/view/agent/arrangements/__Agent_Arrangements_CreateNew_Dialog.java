...
public class __Agent_Arrangements_CreateNew_Dialog {
    ...
    public void addArrangement(String loginId) {
        font = new Font("SansSerif", Font.PLAIN, 20);
        font2 = new Font("SansSerif", Font.PLAIN, 18);
        
        dialog = new JDialog();
        dialog.setTitle("Agent - Create New Arrangement");
        ...
        typeOfRooms = new JLabel("Available Rooms: ");
        ...
        String agent = UsersDAO.getUserHash(Integer.parseInt(loginId));
        System.out.println(loginId);
        System.out.println(agent);
        JComboBox<String> agentsComboBox = new JComboBox<>();
        ...
        List<JLabel> labelList = Arrays.asList(agentNameLabel, arrangementTypeLabel, imagesLabel, dateLabel, capacityLabel, typeOfRooms, typeOfAccomodationLabel, pricePerPersonLabel, fairDiscountLabel, numOfRoomsLabel);
        ...
        createButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(AddArrangement.addArrangement_VALIDATE(arr, roomsNum) == true) {
                	TouristAgent.createArrangement(arr);
