...
public class __Tourist_Reservations_CreateNew_Dialog {
    ...
    public void addReservation(Integer loginId) {
        ...
        dialog = new JDialog();
        dialog.setTitle("Tourist - Create New Reservation");
        ...
        String tourist = UsersDAO.getUserHash(loginId);
     ...
     // Iterate over the ArrayList and add each element to the combo box
        for (Integer number : ArrangementsDAO.arrangementsArray) {
        ...
        createButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
				...
				timeCalendar.setTime(DATEFIELD);
				calendar.set(Calendar.HOUR_OF_DAY, 10);
				calendar.set(Calendar.MINUTE, 10);
				calendar.set(Calendar.SECOND, 10);
				calendar.set(Calendar.MILLISECOND, 10);
				LocalDateTime availableDate = LocalDateTime.ofInstant(calendar.toInstant(), ZoneId.systemDefault());
				//
				...
				Tourist.createReservation(res, "Created");
            }
        });
